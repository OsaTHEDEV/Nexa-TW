...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)]">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[rgba(23,18,51,0.72)] backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          <Link to="/" className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[var(--color-brand)] text-[var(--color-bg)] shadow-[0_12px_30px_rgba(242,118,90,0.22)]">
              <AppWindow size={18} />
            </div>
            <div>
        ...
        {mobileMenuOpen && (
          <div className="border-t border-[var(--color-border)] bg-[rgba(23,18,51,0.94)] md:hidden">
      ...
      <footer className="border-t border-[var(--color-border)] bg-[rgba(23,18,51,0.72)]">
